...
class Employee(models.Model):
    ...
    def _search_filter_for_expense(self, operator, value):
        ...
        if self.user_has_groups('hr_expense.group_hr_expense_user') or self.user_has_groups('account.group_account_user') or self.user_has_groups('hr_expense.group_hr_expense_team_approver'):
