...
def load_xml_data(invoice, load_lines, account_id, product_id=False, analytic_account_id=False, interactive=False):
    ...
    invoice.date = invoice.date_issuance
    ...
    if partner and partner.expense_product_id:
        default_product = partner.expense_product_id
    ...
    _logger.debug('FECR - load_lines: %s - account: %s', load_lines, default_account and default_account.name)
    ...
    if load_lines:
        ...
        for line in lines:
            ...
            for tax_node in tax_nodes:
                ...
                if default_product and default_product.non_tax_deductible:
            ...
            columns = {'name': line.xpath("inv:Detalle", namespaces=namespaces)[0].text,
                       ...
                       'product_id': default_product and default_product.id,
